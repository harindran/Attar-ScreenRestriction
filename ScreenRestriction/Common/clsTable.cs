...
namespace ScreenRestriction.Common
{
    ...
    {        
        ...
        {
            Screen_Restrict_User_Master();        
        }

        #region Master Data Creation

        public void Screen_Restrict_User_Master()
        {
            AddTables("AT_USRSCRN", "Screen Restrict User Header", SAPbobsCOM.BoUTBTableType.bott_MasterData);
            AddTables("AT_USRSCRN1", "Screen Restrict User Lines", SAPbobsCOM.BoUTBTableType.bott_MasterDataLines);
     
            
            //Header Table
            AddFields("@AT_USRSCRN", "UserId", "User Code", SAPbobsCOM.BoFieldTypes.db_Alpha, 30);
            AddFields("@AT_USRSCRN", "Remarks", "Remarks", SAPbobsCOM.BoFieldTypes.db_Memo, 200);

            //Line Table
            AddFields("@AT_USRSCRN1", "TableName", "Table Name", SAPbobsCOM.BoFieldTypes.db_Alpha, 10);
            AddFields("@AT_USRSCRN1", "ObjType", "Object Type", SAPbobsCOM.BoFieldTypes.db_Alpha, 10);
            AddFields("@AT_USRSCRN1", "FieldName", "Field Name", SAPbobsCOM.BoFieldTypes.db_Alpha, 50);
            AddFields("@AT_USRSCRN1", "FieldDesc", "Field Description", SAPbobsCOM.BoFieldTypes.db_Alpha, 80);
            AddFields("@AT_USRSCRN1", "Active", "Active", SAPbobsCOM.BoFieldTypes.db_Alpha, 5, SAPbobsCOM.BoFldSubTypes.st_None, SAPbobsCOM.UDFLinkedSystemObjectTypesEnum.ulNone, "", SAPbobsCOM.BoYesNoEnum.tNO,"N",true, new[] {""});
            AddFields("@AT_USRSCRN1", "ListName", "List Name", SAPbobsCOM.BoFieldTypes.db_Alpha,100);
            AddFields("@AT_USRSCRN1", "ScreenName", "Screen Name", SAPbobsCOM.BoFieldTypes.db_Alpha, 100);


            AddUDO("AT_USRSCRN", "Screen Restrict User", SAPbobsCOM.BoUDOObjType.boud_MasterData, "AT_USRSCRN", new[] { "AT_USRSCRN1" }, new[] { "Code", "Name" },false, true, false);
        }
        ...
        private void AddFields(string strTab, string strCol, string strDesc, SAPbobsCOM.BoFieldTypes nType, int nEditSize = 10, SAPbobsCOM.BoFldSubTypes nSubType = 0, SAPbobsCOM.UDFLinkedSystemObjectTypesEnum LinkedSysObject= 0,string UDTTable="", SAPbobsCOM.BoYesNoEnum Mandatory = SAPbobsCOM.BoYesNoEnum.tNO, string defaultvalue = "", bool Yesno = false, string[] Validvalues = null)
        {
            ...
            try
            {
                //SAPbouiCOM.BoLinkedObject boLinkedObject;
                //boLinkedObject = SAPbouiCOM.BoLinkedObject;
